...
export const getRapportSpecLub = async (typelubrifiantId, year) => {
  return await apiRequest(API_PATHS.RAPPORTS.GENERATE_RAPPORT_SPEC_LUB, 'POST', {
    typelubrifiantId,
    year,
  })
}
...
export const getAnalyseSpcPeriodParcTypeConsom = async (
  parcId,
  dateDu,
  dateAu,
  selectedTypelubrifiant,
) => {
  return await apiRequest(API_PATHS.RAPPORTS.GENERATE_ANALYSE_LUB_PERIOD_PARC, 'POST', {
    parcId,
    dateDu,
    dateAu,
    typelubrifiantId: selectedTypelubrifiant,
  })
}

export const getIndispoParcPeriode = async (selectedParc, dateDu, dateAu) => {
  return await apiRequest(API_PATHS.RAPPORTS.GENERATE_ANALYSE_INDISPO_PARC_PERIODE, 'POST', {
    parcId: selectedParc,
    dateDu,
    dateAu,
  })
...
export const getIndispoEnginsPeriode = async (selectedParc, dateDu, dateAu) => {
  return await apiRequest(API_PATHS.RAPPORTS.GENERATE_ANALYSE_INDISPO_ENGINS_PERIODE, 'POST', {
    parcId: selectedParc,
    dateDu,
    dateAu,
  })
...
export const getPerformancesEnginsPeriode = async (selectedParc, dateDu, dateAu) => {
  return await apiRequest(API_PATHS.RAPPORTS.GENERATE_ANALYSE_PERFORMANCES_ENGINS_PERIODE, 'POST', {
    parcId: selectedParc,
    dateDu,
    dateAu,
  })
