...
export const createTypeconsommationlub = async (typeconsommationlub) => {
  return apiRequest(
    API_PATHS.TYPECONSOMMATIONLUBS.ADD_TYPECONSOMMATIONLUBS,
    'POST',
    typeconsommationlub,
  )
}
...
export const updateTypeconsommationlub = async (typeconsommationlub) => {
  return apiRequest(
    API_PATHS.TYPECONSOMMATIONLUBS.UPDATE_TYPECONSOMMATIONLUBS(typeconsommationlub.id),
    'PATCH',
    typeconsommationlub,
  )
}
...
export const deleteTypeconsommationlub = async (typeconsommationlub) => {
  return apiRequest(
    API_PATHS.TYPECONSOMMATIONLUBS.DELETE_TYPECONSOMMATIONLUBS(typeconsommationlub.id),
    'DELETE',
    typeconsommationlub,
  )
}
