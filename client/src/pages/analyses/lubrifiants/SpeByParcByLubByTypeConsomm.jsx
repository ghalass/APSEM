      ...
      <CCardBody>
              ...
              <div className="table-responsive">
                ...
                >
                  <CTableHead className="table-light">
                    <CTableRow>
                      <CTableHeaderCell colSpan={3} className="text-center bg-light">
                        <strong>
        ...
        {!getAnalyse.isFetching &&
          ...
          selectedTypelubrifiant !== '' && (
            <div className="text-center text-muted py-5">
              ...
              <p>Aucune consommation n'est enregistrée pour les critères sélectionnés.</p>
            </div>
          )}
        ...
        {getAnalyse.isFetching && (
          <div className="text-center py-5">
            ...
            <div className="mt-3">Analyse des données en cours...</div>
          </div>
        )}
      </CCardBody>
    </CCard>
